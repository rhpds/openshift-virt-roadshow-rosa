...
+
image::module-08-vmexamples/11_Imported_VMs_List.png[link=self, window=blank, width=100%]
+
...
+
image::module-08-vmexamples/12_Imported_VMs_YAML.png[link=self, window=blank, width=100%]
+
...
+
image::module-08-vmexamples/13_Navigate_Service.png[link=self, window=blank, width=100%]
+
...
+
image::module-08-vmexamples/14_Service_YAML.png[link=self, window=blank, width=100%]

. Press *Create*.

. From the details page for the newly created *webapp* Service, locate *Pod selector* link and click it.
+
image::module-08-vmexamples/15_Imported_VMs_PodSelector.png[link=self, window=blank, width=100%]
+

. Verify the two Windows VMs are properly identified and targeted by the Service.
+
image::module-08-vmexamples/16_Imported_VMs_Pods.png[link=self, window=blank, width=100%]
+
...
+
image::module-08-vmexamples/17_Route_Navigation.png[link=self, window=blank, width=100%]
...
+
image::module-08-vmexamples/18_Create_Route.png[link=self, window=blank, width=100%]

. Navigate to the address shown in *Location* field
+
image::module-08-vmexamples/19_Route_Access.png[link=self, window=blank, width=100%]
...
+
image::module-08-vmexamples/20_WebApp_Error.png[link=self, window=blank, width=100%]
+
...
image::module-08-vmexamples/21_Database_YAML.png[link=self, window=blank, width=100%]
...
+
image::module-08-vmexamples/22_WebApp_Success.png[link=self, window=blank, width=100%]
